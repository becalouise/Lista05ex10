...
public class Ex10 {
    ...
    public static void resolve(int resultado) {
        if (resultado == 7 || resultado == 11) {
            System.out.println("Resultado: " + resultado + "NATURAL. Você ganhou!");
        } else if (resultado == 2 || resultado == 3 || resultado == 12) {
            System.out.println("Resultado: " + resultado + "CRAPS. Você perdeu!");
        } else {
            ...
            while (loop != 2) {
                ...
                System.out.println("Pressione 1 e tecle 'enter' para jogar os dados novamente ou 2 para sair do jogo.");
                int entrada = sc.nextInt();
